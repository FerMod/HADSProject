...
<asp:Content ID="TeacherTasksContent" ContentPlaceHolderID="TeacherContent" runat="server">
	...
	<div class="form-group">
		...
		<asp:DropDownList ID="DropDownSubjects" CssClass="custom-select" runat="server" TabIndex="1" AutoPostBack="True" DataSourceID="SubjectsDataSource" DataTextField="codigo" DataValueField="codigo" OnDataBinding="DropDownSubjects_DataBinding" OnSelectedIndexChanged="DropDownSubjects_SelectedIndexChanged"/>
	</div>

	<div class="form-group">
		<asp:GridView ID="GridViewTasksMeans" ClientIDMode="Static" CssClass="table table-sm table-bordered table-responsive-md table-hover table-row-middle" DataKeyNames="CodAsig" AutoPostBack="True" runat="server" TabIndex="2" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" AllowSorting="True" EmptyDataText="No tasks found." OnSorting="GridViewTasks_Sorting" >
			<Columns>
				<asp:BoundField DataField="Email" HeaderText="Email" SortExpression="Email" ReadOnly="True" />
				<asp:BoundField DataField="MediaHReales" HeaderText="Average Tasks Time" SortExpression="MediaHReales" ReadOnly="True" />
			</Columns>
