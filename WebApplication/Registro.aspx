...
<body>
	<form id="form1" runat="server">
		...
		<div style="margin: 5px; padding: 5px">
			...
			<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="textBoxPassword" ErrorMessage="Required field" Font-Bold="True" Font-Size="Small" ForeColor="Red"></asp:RequiredFieldValidator>
			<asp:CompareValidator ID="PasswordCompareValidator" runat="server" ErrorMessage="Passwords does not match" Font-Bold="True" Font-Size="Small" ForeColor="Red"></asp:CompareValidator>
		</div>
		<div style="margin: 5px; padding: 5px">
		...
		<div style="margin: 5px; padding: 5px">
			<asp:Button ID="buttonLogin" runat="server" Text="Create Account" OnClick="ButtonLogin_Click" Width="130px" CssClass="auto-style1" />
		</div>
	</form>
</body>
</html>
